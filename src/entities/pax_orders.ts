...
export class PaxOrder {
    ...
    @OneToMany(type => PaxOrderTransaction, pax_order_transactions => pax_order_transactions.buy_order_id)
    pax_order_buy_transactions: PaxOrderTransaction[];

    @OneToMany(type => PaxOrderTransaction, pax_order_transactions => pax_order_transactions.sell_order_id)
    pax_order_sell_transactions: PaxOrderTransaction[];
